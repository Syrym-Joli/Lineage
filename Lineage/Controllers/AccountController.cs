        ...
        public ActionResult Login(LoginModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    return RedirectToAction("index", "Ltree");
                }
                else
                {
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    using (UserContext db = new UserContext())
                    {
                        db.Users.Add(new User { Email = model.Email, Password = model.Password, Surname = model.Surname, Name = model.Name,});
                        db.SaveChanges();
